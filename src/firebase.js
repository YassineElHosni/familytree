...
export const database = {
  ...
  membersManager: {
    ...
    addAll: async members =>
      await Promise.all([...members.reduce((t, o) => t = [...t, database.membersManager.add(o)], [])])
      .then((values) => values.reduce((t, o) => [...t, o.key], [])),
    setAll: async members =>
      await Promise.all([...members.reduce((t, o) => t = [...t, database.membersManager.set(o)], [])])
      .then((values) => values.reduce((t, o) => [...t, o.key], [])),

    showAll: () => dbRoot.child("members").on('value', s => console.log(s.val())),
    getAll: async () => Object.entries(await (await dbRoot.child("members").once("value", s => s.val())).val())
      .map(o => o = {
        id: o[0],
        ...o[1]
      })
  ...
  relationshipsManager: {
    ...
    addAll: async relationships =>
      await Promise.all([...relationships.reduce((t, o) => t = [...t, database.relationshipsManager.push(o)], [])])
      .then((values) => values.reduce((t, o) => [...t, o.key], [])),

    setAll: async relationships =>
      await Promise.all([...relationships.reduce((t, o) => t = [...t, database.relationshipsManager.set(o)], [])])
      .then((values) => values.reduce((t, o) => [...t, o.key], [])),

    showAll: () => dbRoot.child("relationships").on('value', s => console.log(s.val())),
    getAll: async () => Object.entries(await (await dbRoot.child("relationships").once("value", s => s.val())).val())
      .map(o => o = {
        id: o[0],
        ...o[1]
      })
